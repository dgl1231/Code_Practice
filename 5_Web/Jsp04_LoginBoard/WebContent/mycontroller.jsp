...
<body>
	...
	if (command.equals("boardlist")) {
		...
		/*
			forward : req, res 가 유지되며 화면 전환.
			redirect : 새로운 req,res 페이지를 요청한것과 같은 방식으로 페이지 이동
		*/
	} else if (command.equals("boardinsertform")) { //단순 페이지 이동
	...
	request.setAttribute("dto", dto); //selecton에서 받아온 dto를 dto라고 명칭하고 화면전환할대 dto안에있는 값을 들고 화면 전환함
	pageContext.forward("boarddetail.jsp");// 화면전환
	...
	<script type="text/javascript">
		alert("수정성공");
		location.href = "mycontroller.jsp?command=boarddetail&seq=" +
	<%=seq%>
