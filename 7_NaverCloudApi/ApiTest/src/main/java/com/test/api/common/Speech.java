...
public class Speech {
	...
	private static final String SECRET = "ae2e7b95cf234871b48fb1ff05e2298f";
    // Clova Speech invoke URL
	private static final String INVOKE_URL = "https://clovaspeech-gw.ncloud.com/external/v1/3028/41f571bd5d1f9eb05c5b9c802d8f36121a5044769c646460a36238086d89f40e";
	...
	public String sppechTest(String path) {
		final Speech clovaSpeechClient = new Speech();
		NestRequestEntity requestEntity = new NestRequestEntity();
		final String result =
			clovaSpeechClient.upload(new File(path+"\\video01.mp4"), requestEntity);
